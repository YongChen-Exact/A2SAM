...
class ImageEncoderViT(nn.Module):
    def __init__(
        ...
        if self.tuning_mode == "gps" or self.tuning_mode ==  "full" or self.tuning_mode ==  "cps":
            pass
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        if self.tuning_mode == "gps" or self.tuning_mode == "full" or self.tuning_mode == "ssf" or self.tuning_mode == "cps":
            pass
        else:
